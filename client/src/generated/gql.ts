...
type Documents = {
  ...
  "query getOrderOrigin($id: Float!, $editionId: Float!) {\n  orderOrigin(id: $id) {\n    id\n    name\n    isPhysical\n    budgetLines(editionId: $editionId) {\n      id\n      name\n      estimatedUnitPrice\n      isFreePrice\n      category {\n        id\n        name\n        color\n        isUsed\n      }\n    }\n  }\n}": typeof types.GetOrderOriginDocument;
  ...
  "query getEditionsComparison {\n  editions {\n    id\n    name\n    startDate\n    totalIncome\n    totalExpense\n  }\n}": typeof types.GetEditionsComparisonDocument;
  ...
  "mutation closeEdition($editionId: Float!, $incomeAdjustment: Float!, $nextEditionName: String!, $nextEditionStartDate: String!, $nextEditionEndDate: String!) {\n  closeEdition(\n    editionId: $editionId\n    incomeAdjustment: $incomeAdjustment\n    nextEditionName: $nextEditionName\n    nextEditionStartDate: $nextEditionStartDate\n    nextEditionEndDate: $nextEditionEndDate\n  ) {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}": typeof types.CloseEditionDocument;
  ...
  "query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}": typeof types.GetEditionClosingSummaryDocument;
...
const documents: Documents = {
  ...
  "query getEditionsComparison {\n  editions {\n    id\n    name\n    startDate\n    totalIncome\n    totalExpense\n  }\n}":
    types.GetEditionsComparisonDocument,
  "query getEditions {\n  editions {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}":
  ...
  "query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}":
    types.GetEditionClosingSummaryDocument,
  "query getGoogleDriveConfig($editionId: Float!) {\n  googleDriveConfig(editionId: $editionId) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}":
...
export function graphql(
  source: "mutation addBudgetLine($name: String!, $budgetCategoryId: Float!, $description: String, $editionId: Float!, $estimatedQuantity: Int!, $estimatedUnitPrice: Float!, $isFreePrice: Boolean, $lineType: LineTypeEnum!) {\n  addBudgetLine(\n    name: $name\n    budgetCategoryId: $budgetCategoryId\n    description: $description\n    editionId: $editionId\n    estimatedQuantity: $estimatedQuantity\n    estimatedUnitPrice: $estimatedUnitPrice\n    isFreePrice: $isFreePrice\n    lineType: $lineType\n  ) {\n    id\n    name\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation deleteBudgetLine($id: Float!) {\n  deleteBudgetLine(id: $id) {\n    id\n    name\n  }\n}",
): (typeof documents)["mutation deleteBudgetLine($id: Float!) {\n  deleteBudgetLine(id: $id) {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getBudgetCategories {\n  budgetCategories {\n    id\n    name\n    color\n    isUsed\n  }\n}",
): (typeof documents)["query getBudgetCategories {\n  budgetCategories {\n    id\n    name\n    color\n    isUsed\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getBudgetLines($editionId: Float!, $budgetLineType: LineTypeEnum!, $excludeHelloAsso: Boolean) {\n  budgetLines(\n    editionId: $editionId\n    budgetLineType: $budgetLineType\n    excludeHelloAsso: $excludeHelloAsso\n  ) {\n    id\n    name\n    description\n    estimatedQuantity\n    estimatedUnitPrice\n    isFreePrice\n    realCost\n    salesCount\n    lineType\n    category {\n      id\n      name\n      color\n    }\n    helloAssoProductId\n  }\n}",
): (typeof documents)["query getBudgetLines($editionId: Float!, $budgetLineType: LineTypeEnum!, $excludeHelloAsso: Boolean) {\n  budgetLines(\n    editionId: $editionId\n    budgetLineType: $budgetLineType\n    excludeHelloAsso: $excludeHelloAsso\n  ) {\n    id\n    name\n    description\n    estimatedQuantity\n    estimatedUnitPrice\n    isFreePrice\n    realCost\n    salesCount\n    lineType\n    category {\n      id\n      name\n      color\n    }\n    helloAssoProductId\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation updateBudgetLine($id: Float!, $name: String, $budgetCategoryId: Float, $description: String, $editionId: Float, $estimatedQuantity: Int, $estimatedUnitPrice: Float, $isFreePrice: Boolean) {\n  updateBudgetLine(\n    id: $id\n    name: $name\n    budgetCategoryId: $budgetCategoryId\n    description: $description\n    editionId: $editionId\n    estimatedQuantity: $estimatedQuantity\n    estimatedUnitPrice: $estimatedUnitPrice\n    isFreePrice: $isFreePrice\n  ) {\n    id\n    name\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation upsertBudgetCategory($id: Float, $name: String!, $color: String!) {\n  upsertBudgetCategory(id: $id, name: $name, color: $color) {\n    id\n    name\n    color\n  }\n}",
): (typeof documents)["mutation upsertBudgetCategory($id: Float, $name: String!, $color: String!) {\n  upsertBudgetCategory(id: $id, name: $name, color: $color) {\n    id\n    name\n    color\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getOrderOrigin($id: Float!, $editionId: Float!) {\n  orderOrigin(id: $id) {\n    id\n    name\n    isPhysical\n    budgetLines(editionId: $editionId) {\n      id\n      name\n      estimatedUnitPrice\n      isFreePrice\n      category {\n        id\n        name\n        color\n        isUsed\n      }\n    }\n  }\n}",
): (typeof documents)["query getOrderOrigin($id: Float!, $editionId: Float!) {\n  orderOrigin(id: $id) {\n    id\n    name\n    isPhysical\n    budgetLines(editionId: $editionId) {\n      id\n      name\n      estimatedUnitPrice\n      isFreePrice\n      category {\n        id\n        name\n        color\n        isUsed\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getSumUpConfig {\n  sumUpConfig {\n    affiliateKey\n    appId\n  }\n}",
): (typeof documents)["query getSumUpConfig {\n  sumUpConfig {\n    affiliateKey\n    appId\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation validateOrder($editionId: Float!, $originId: Float!, $paymentMethod: ValidateOrderPaymentMethodInput!, $sales: [ValidateOrderSalesInput!]!) {\n  validateOrder(\n    editionId: $editionId\n    originId: $originId\n    paymentMethod: $paymentMethod\n    sales: $sales\n  ) {\n    id\n  }\n}",
 ...
 */
export function graphql(
  source: "query getBudgetStatsByCategories($editionId: Float!, $lineType: LineTypeEnum!) {\n  getBudgetStatsByCategories(editionId: $editionId, lineType: $lineType) {\n    categoryName\n    totalEstimated\n    total\n  }\n}",
): (typeof documents)["query getBudgetStatsByCategories($editionId: Float!, $lineType: LineTypeEnum!) {\n  getBudgetStatsByCategories(editionId: $editionId, lineType: $lineType) {\n    categoryName\n    totalEstimated\n    total\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getEditionStats($editionId: Float!) {\n  edition(id: $editionId) {\n    id\n    totalExpense\n    totalIncome\n    totalPrevisionnalExpense\n    totalPrevisionnalIncome\n  }\n}",
): (typeof documents)["query getEditionStats($editionId: Float!) {\n  edition(id: $editionId) {\n    id\n    totalExpense\n    totalIncome\n    totalPrevisionnalExpense\n    totalPrevisionnalIncome\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getEditionsComparison {\n  editions {\n    id\n    name\n    startDate\n    totalIncome\n    totalExpense\n  }\n}",
): (typeof documents)["query getEditionsComparison {\n  editions {\n    id\n    name\n    startDate\n    totalIncome\n    totalExpense\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getEditions {\n  editions {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}",
): (typeof documents)["query getEditions {\n  editions {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation addInvoice($name: String!, $authorId: String!, $editionId: Float!, $note: String, $payments: [AddInvoicePaymentsInput!]!, $status: InvoiceStatus!, $totalAmount: Float!, $vendorId: Float!, $withoutTVA: Boolean) {\n  addInvoice(\n    name: $name\n    editionId: $editionId\n    note: $note\n    payments: $payments\n    status: $status\n    totalAmount: $totalAmount\n    vendorId: $vendorId\n    authorId: $authorId\n    withoutTVA: $withoutTVA\n  ) {\n    id\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation addOrUpdateVendor($id: Float, $name: String!, $address: String, $email: String, $phone: String, $description: String) {\n  addOrUpdateVendor(\n    id: $id\n    name: $name\n    address: $address\n    email: $email\n    phone: $phone\n    description: $description\n  ) {\n    id\n    name\n    address\n    email\n    phoneNumber\n    description\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation deleteInvoice($id: Float!) {\n  deleteInvoice(id: $id) {\n    id\n  }\n}",
): (typeof documents)["mutation deleteInvoice($id: Float!) {\n  deleteInvoice(id: $id) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteInvoiceFile($id: Float!, $deleteFromDrive: Boolean!) {\n  deleteInvoiceFile(id: $id, deleteFromDrive: $deleteFromDrive)\n}",
): (typeof documents)["mutation deleteInvoiceFile($id: Float!, $deleteFromDrive: Boolean!) {\n  deleteInvoiceFile(id: $id, deleteFromDrive: $deleteFromDrive)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getInvoices($editionId: Float!, $status: InvoiceStatus) {\n  invoices(editionId: $editionId, status: $status) {\n    id\n    name\n    vendorId\n    vendor {\n      id\n      name\n    }\n    totalAmount\n    note\n    author {\n      id\n    }\n    executedAt\n    status\n    payments {\n      id\n      budgetLineId\n      quantity\n      unitPrice\n    }\n    invoiceFiles {\n      id\n      fileName\n      mimeType\n      sizeBytes\n      createdAt\n    }\n  }\n}",
): (typeof documents)["query getInvoices($editionId: Float!, $status: InvoiceStatus) {\n  invoices(editionId: $editionId, status: $status) {\n    id\n    name\n    vendorId\n    vendor {\n      id\n      name\n    }\n    totalAmount\n    note\n    author {\n      id\n    }\n    executedAt\n    status\n    payments {\n      id\n      budgetLineId\n      quantity\n      unitPrice\n    }\n    invoiceFiles {\n      id\n      fileName\n      mimeType\n      sizeBytes\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getVendors {\n  vendors {\n    id\n    name\n  }\n}",
): (typeof documents)["query getVendors {\n  vendors {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation updateInvoice($id: Float!, $name: String, $authorId: String, $editionId: Float!, $note: String, $payments: [UpdateInvoicePaymentsInput!], $status: InvoiceStatus, $totalAmount: Float, $vendorId: Float) {\n  updateInvoice(\n    id: $id\n    name: $name\n    editionId: $editionId\n    note: $note\n    payments: $payments\n    status: $status\n    totalAmount: $totalAmount\n    vendorId: $vendorId\n    authorId: $authorId\n  ) {\n    id\n  }\n}",
 ...
 */
export function graphql(
  source: "query getOrderOrigins($onlyPhysical: Boolean) {\n  orderOrigins(onlyPhysical: $onlyPhysical) {\n    id\n    name\n    isPhysical\n  }\n}",
): (typeof documents)["query getOrderOrigins($onlyPhysical: Boolean) {\n  orderOrigins(onlyPhysical: $onlyPhysical) {\n    id\n    name\n    isPhysical\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getOrders($editionId: Float!, $from: String, $to: String, $originIds: [Float!]) {\n  orders(editionId: $editionId, from: $from, to: $to, originIds: $originIds) {\n    id\n    totalAmount\n    executedAt\n    payerFirstName\n    payerLastName\n    payerEmail\n    helloAssoOrderId\n    authorId\n    originId\n    origin {\n      id\n      name\n    }\n    author {\n      id\n      username\n    }\n    sales {\n      id\n      budgetLineId\n      quantity\n      unitPrice\n      executedAt\n      budgetLine {\n        id\n        name\n        estimatedUnitPrice\n        category {\n          id\n          name\n          color\n        }\n      }\n    }\n  }\n}",
): (typeof documents)["query getOrders($editionId: Float!, $from: String, $to: String, $originIds: [Float!]) {\n  orders(editionId: $editionId, from: $from, to: $to, originIds: $originIds) {\n    id\n    totalAmount\n    executedAt\n    payerFirstName\n    payerLastName\n    payerEmail\n    helloAssoOrderId\n    authorId\n    originId\n    origin {\n      id\n      name\n    }\n    author {\n      id\n      username\n    }\n    sales {\n      id\n      budgetLineId\n      quantity\n      unitPrice\n      executedAt\n      budgetLine {\n        id\n        name\n        estimatedUnitPrice\n        category {\n          id\n          name\n          color\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation AddHelloAssoConfig($formSlug: String!, $editionId: Float!, $enableSynchro: Boolean!, $budgetCategoryId: Float) {\n  addHelloAssoConfig(\n    formSlug: $formSlug\n    editionId: $editionId\n    enableSynchro: $enableSynchro\n    budgetCategoryId: $budgetCategoryId\n  ) {\n    id\n    formSlug\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation addOrUpdateOrderOrigin($id: Float, $name: String!, $budgetLineIds: [Float!]) {\n  addOrUpdateOrderOrigin(id: $id, name: $name, budgetLineIds: $budgetLineIds) {\n    id\n    name\n  }\n}",
): (typeof documents)["mutation addOrUpdateOrderOrigin($id: Float, $name: String!, $budgetLineIds: [Float!]) {\n  addOrUpdateOrderOrigin(id: $id, name: $name, budgetLineIds: $budgetLineIds) {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation closeEdition($editionId: Float!, $incomeAdjustment: Float!, $nextEditionName: String!, $nextEditionStartDate: String!, $nextEditionEndDate: String!) {\n  closeEdition(\n    editionId: $editionId\n    incomeAdjustment: $incomeAdjustment\n    nextEditionName: $nextEditionName\n    nextEditionStartDate: $nextEditionStartDate\n    nextEditionEndDate: $nextEditionEndDate\n  ) {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}",
): (typeof documents)["mutation closeEdition($editionId: Float!, $incomeAdjustment: Float!, $nextEditionName: String!, $nextEditionStartDate: String!, $nextEditionEndDate: String!) {\n  closeEdition(\n    editionId: $editionId\n    incomeAdjustment: $incomeAdjustment\n    nextEditionName: $nextEditionName\n    nextEditionStartDate: $nextEditionStartDate\n    nextEditionEndDate: $nextEditionEndDate\n  ) {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteBudgetCategory($id: Float!) {\n  deleteBudgetCategory(id: $id) {\n    id\n    name\n  }\n}",
): (typeof documents)["mutation deleteBudgetCategory($id: Float!) {\n  deleteBudgetCategory(id: $id) {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteOrderOrigin($id: Float!) {\n  deleteOrderOrigin(id: $id) {\n    id\n    name\n  }\n}",
): (typeof documents)["mutation deleteOrderOrigin($id: Float!) {\n  deleteOrderOrigin(id: $id) {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation disconnectGoogleDrive($editionId: Float!) {\n  disconnectGoogleDrive(editionId: $editionId) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}",
): (typeof documents)["mutation disconnectGoogleDrive($editionId: Float!) {\n  disconnectGoogleDrive(editionId: $editionId) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}",
): (typeof documents)["query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getGoogleDriveConfig($editionId: Float!) {\n  googleDriveConfig(editionId: $editionId) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}",
): (typeof documents)["query getGoogleDriveConfig($editionId: Float!) {\n  googleDriveConfig(editionId: $editionId) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query getHelloAssoConfig($editionId: Float!) {\n  helloAssoConfig(editionId: $editionId) {\n    id\n    formSlug\n  }\n}",
): (typeof documents)["query getHelloAssoConfig($editionId: Float!) {\n  helloAssoConfig(editionId: $editionId) {\n    id\n    formSlug\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation synchroSales($helloAssoConfigId: Float!, $from: String!, $to: String!) {\n  synchroSales(helloAssoConfigId: $helloAssoConfigId, from: $from, to: $to) {\n    id\n  }\n}",
): (typeof documents)["mutation synchroSales($helloAssoConfigId: Float!, $from: String!, $to: String!) {\n  synchroSales(helloAssoConfigId: $helloAssoConfigId, from: $from, to: $to) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation updateEdition($id: Float!, $name: String, $startDate: String, $endDate: String, $openingBalance: Float) {\n  updateEdition(\n    id: $id\n    name: $name\n    startDate: $startDate\n    endDate: $endDate\n    openingBalance: $openingBalance\n  ) {\n    id\n    name\n    startDate\n    endDate\n    openingBalance\n  }\n}",
): (typeof documents)["mutation updateEdition($id: Float!, $name: String, $startDate: String, $endDate: String, $openingBalance: Float) {\n  updateEdition(\n    id: $id\n    name: $name\n    startDate: $startDate\n    endDate: $endDate\n    openingBalance: $openingBalance\n  ) {\n    id\n    name\n    startDate\n    endDate\n    openingBalance\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation updateGoogleDriveConfig($editionId: Float!, $invoiceFolderId: String!) {\n  updateGoogleDriveConfig(\n    editionId: $editionId\n    invoiceFolderId: $invoiceFolderId\n  ) {\n    editionId\n    isConnected\n    invoiceFolderId\n    googleAccountEmail\n    connectedAt\n  }\n}",
