 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getOrderOrigin($id: Float!, $editionId: Float!) {\n  orderOrigin(id: $id) {\n    id\n    name\n    isPhysical\n    budgetLines(editionId: $editionId) {\n      id\n      name\n      estimatedUnitPrice\n      isFreePrice\n      category {\n        id\n        name\n        color\n        isUsed\n      }\n    }\n  }\n}"): (typeof documents)["query getOrderOrigin($id: Float!, $editionId: Float!) {\n  orderOrigin(id: $id) {\n    id\n    name\n    isPhysical\n    budgetLines(editionId: $editionId) {\n      id\n      name\n      estimatedUnitPrice\n      isFreePrice\n      category {\n        id\n        name\n        color\n        isUsed\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation closeEdition($editionId: Float!, $incomeAdjustment: Float!, $nextEditionName: String!, $nextEditionStartDate: String!, $nextEditionEndDate: String!) {\n  closeEdition(\n    editionId: $editionId\n    incomeAdjustment: $incomeAdjustment\n    nextEditionName: $nextEditionName\n    nextEditionStartDate: $nextEditionStartDate\n    nextEditionEndDate: $nextEditionEndDate\n  ) {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}"): (typeof documents)["mutation closeEdition($editionId: Float!, $incomeAdjustment: Float!, $nextEditionName: String!, $nextEditionStartDate: String!, $nextEditionEndDate: String!) {\n  closeEdition(\n    editionId: $editionId\n    incomeAdjustment: $incomeAdjustment\n    nextEditionName: $nextEditionName\n    nextEditionStartDate: $nextEditionStartDate\n    nextEditionEndDate: $nextEditionEndDate\n  ) {\n    id\n    name\n    active\n    startDate\n    endDate\n    openingBalance\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}"): (typeof documents)["query getEditionClosingSummary($id: Float!) {\n  edition(id: $id) {\n    id\n    openingBalance\n    totalIncome\n    totalExpense\n    totalPrevisionnalIncome\n    totalPrevisionnalExpense\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
