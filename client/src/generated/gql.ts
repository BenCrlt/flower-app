...
type Documents = {
    ...
    "query getProducts($editionId: Float!) {\n  products(editionId: $editionId) {\n    id\n    name\n    unitPrice\n    salesCount\n  }\n}": typeof types.GetProductsDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getProducts($editionId: Float!) {\n  products(editionId: $editionId) {\n    id\n    name\n    unitPrice\n    salesCount\n  }\n}"): (typeof documents)["query getProducts($editionId: Float!) {\n  products(editionId: $editionId) {\n    id\n    name\n    unitPrice\n    salesCount\n  }\n}"];
