...
type Documents = {
    ...
    "query getOrders($editionId: Float!, $from: String, $to: String) {\n  orders(editionId: $editionId, from: $from, to: $to) {\n    id\n    totalAmount\n    executedAt\n    payerFirstName\n    payerLastName\n    payerEmail\n    helloAssoOrderId\n    authorId\n    author {\n      id\n      username\n    }\n    sales {\n      id\n      budgetLineId\n      quantity\n      executedAt\n      budgetLine {\n        id\n        name\n        estimatedUnitPrice\n        category {\n          id\n          name\n          color\n        }\n      }\n    }\n  }\n}": typeof types.GetOrdersDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation addInvoice($name: String!, $authorId: String!, $editionId: Float!, $note: String, $payments: [AddInvoicePaymentsInput!]!, $status: InvoiceStatus!, $totalAmount: Float!, $vendorId: Float!) {\n  addInvoice(\n    name: $name\n    editionId: $editionId\n    note: $note\n    payments: $payments\n    status: $status\n    totalAmount: $totalAmount\n    vendorId: $vendorId\n    authorId: $authorId\n  ) {\n    id\n  }\n}"): (typeof documents)["mutation addInvoice($name: String!, $authorId: String!, $editionId: Float!, $note: String, $payments: [AddInvoicePaymentsInput!]!, $status: InvoiceStatus!, $totalAmount: Float!, $vendorId: Float!) {\n  addInvoice(\n    name: $name\n    editionId: $editionId\n    note: $note\n    payments: $payments\n    status: $status\n    totalAmount: $totalAmount\n    vendorId: $vendorId\n    authorId: $authorId\n  ) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getOrders($editionId: Float!, $from: String, $to: String) {\n  orders(editionId: $editionId, from: $from, to: $to) {\n    id\n    totalAmount\n    executedAt\n    payerFirstName\n    payerLastName\n    payerEmail\n    helloAssoOrderId\n    authorId\n    author {\n      id\n      username\n    }\n    sales {\n      id\n      budgetLineId\n      quantity\n      executedAt\n      budgetLine {\n        id\n        name\n        estimatedUnitPrice\n        category {\n          id\n          name\n          color\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query getOrders($editionId: Float!, $from: String, $to: String) {\n  orders(editionId: $editionId, from: $from, to: $to) {\n    id\n    totalAmount\n    executedAt\n    payerFirstName\n    payerLastName\n    payerEmail\n    helloAssoOrderId\n    authorId\n    author {\n      id\n      username\n    }\n    sales {\n      id\n      budgetLineId\n      quantity\n      executedAt\n      budgetLine {\n        id\n        name\n        estimatedUnitPrice\n        category {\n          id\n          name\n          color\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
