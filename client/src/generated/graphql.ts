...
export type GetInvoicesQuery = { __typename?: 'Query', invoices: Array<{ __typename?: 'InvoicesItem', id: number, totalAmount: string, note?: string | null, executedAt?: string | null, status: InvoiceStatus, vendor?: { __typename?: 'VendorsItem', id: number, name: string } | null, author?: { __typename?: 'UsersItem', id: number } | null, payments: Array<{ __typename?: 'PaymentsItem', id: number, quantity: number, unitPrice: string }> }> };
