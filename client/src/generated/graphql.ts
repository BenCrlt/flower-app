...
export type GetBudgetLinesQuery = { __typename?: 'Query', budgetLines: Array<{ __typename?: 'BudgetLinesItem', id: number, name: string, description?: string | null, estimatedQuantity: number, estimatedUnitPrice: number, category?: { __typename?: 'BudgetCategoriesItem', name: string } | null }> };
