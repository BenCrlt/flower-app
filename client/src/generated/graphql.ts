...
export type GetOrderOriginQuery = { __typename?: 'Query', orderOrigin?: { __typename?: 'OrderOriginsItem', id: number, name: string, isPhysical: boolean } | null };

export type GetSumUpConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSumUpConfigQuery = { __typename?: 'Query', sumUpConfig: { __typename?: 'SumUpConfig', affiliateKey: string, appId: string, callbackUrl: string } };
