...
export type GetOrderOriginQuery = { __typename?: 'Query', orderOrigin?: { __typename?: 'OrderOriginsItem', id: number, name: string, isPhysical: boolean, budgetLines: Array<{ __typename?: 'BudgetLinesItem', id: number, name: string, estimatedUnitPrice: string, category?: { __typename?: 'BudgetCategoriesItem', id: number, name: string, color: string } | null }> } | null };
