...
export type GetEditionStatsQuery = { __typename?: 'Query', edition?: (
    { __typename?: 'EditionsItem' }
    & { ' $fragmentRefs'?: { 'EditionStatsFragment': EditionStatsFragment } }
  ) | null };

export type EditionStatsFragment = { __typename?: 'EditionsItem', id: number, totalExpense: number, totalIncome: number, totalPrevisionnalExpense: number, totalPrevisionnalIncome: number } & { ' $fragmentName'?: 'EditionStatsFragment' };

export type GetEditionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEditionsQuery = { __typename?: 'Query', editions: Array<{ __typename?: 'EditionsItem', id: number, name: string, active: boolean, startDate: string, totalExpense: number, totalIncome: number, totalPrevisionnalExpense: number, totalPrevisionnalIncome: number }> };
...
export const EditionStatsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EditionStats"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"EditionsItem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalExpense"}},{"kind":"Field","name":{"kind":"Name","value":"totalIncome"}},{"kind":"Field","name":{"kind":"Name","value":"totalPrevisionnalExpense"}},{"kind":"Field","name":{"kind":"Name","value":"totalPrevisionnalIncome"}}]}}]} as unknown as DocumentNode<EditionStatsFragment, unknown>;
