...
export type AddBudgetLineMutation = {
  __typename?: "Mutation";
  addBudgetLine?: {
    __typename?: "BudgetLinesItem";
    id: number;
...
export type GetBudgetCategoriesQuery = {
  __typename?: "Query";
...
export type GetBudgetLinesQuery = {
  __typename?: "Query";
  budgetLines: Array<{
    __typename?: "BudgetLinesItem";
    id: number;
...
export type UpsertBudgetCategoryMutation = {
  __typename?: "Mutation";
...
export type GetOrderOriginQuery = {
  __typename?: "Query";
  orderOrigin?: {
    __typename?: "OrderOriginsItem";
    id: number;
...
export type GetSumUpConfigQuery = {
  __typename?: "Query";
  sumUpConfig: {
    __typename?: "SumUpConfig";
    affiliateKey: string;
...
export type ValidateOrderMutation = {
  __typename?: "Mutation";
  validateOrder?: { __typename?: "OrdersItem"; id: number } | null;
};
...
export type GetBudgetStatsByCategoriesQuery = {
  __typename?: "Query";
  getBudgetStatsByCategories: Array<{
    __typename?: "GetBudgetStatsByCategories";
    categoryName: string;
...
export type GetEditionStatsQuery = {
  __typename?: "Query";
  edition?: {
    __typename?: "EditionsItem";
    id: number;
...
export type GetEditionsComparisonQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetEditionsComparisonQuery = {
  __typename?: "Query";
  editions: Array<{
    __typename?: "EditionsItem";
    id: number;
...
export type AddInvoiceMutation = {
  __typename?: "Mutation";
  addInvoice?: { __typename?: "InvoicesItem"; id: number } | null;
};
...
export type AddOrUpdateVendorMutation = {
  __typename?: "Mutation";
  addOrUpdateVendor?: {
    __typename?: "VendorsItem";
    id: number;
...
export type DeleteInvoiceMutation = {
  __typename?: "Mutation";
  deleteInvoice?: { __typename?: "InvoicesItem"; id: number } | null;
};
...
export type DeleteInvoiceFileMutation = {
  __typename?: "Mutation";
...
export type GetInvoicesQuery = {
  ...
  invoices: Array<{
    ...
    status: InvoicesStatusEnum;
    vendor?: { __typename?: "VendorsItem"; id: number; name: string } | null;
    author?: { __typename?: "UserItem"; id: string } | null;
    payments: Array<{
      __typename?: "PaymentsItem";
      id: number;
      budgetLineId: number;
...
export type GetVendorsQuery = {
  __typename?: "Query";
  vendors: Array<{ __typename?: "VendorsItem"; id: number; name: string }>;
};
...
export type UpdateInvoiceMutationVariables = Exact<{
  ...
  note?: InputMaybe<Scalars["String"]["input"]>;
  payments?: InputMaybe<
    Array<UpdateInvoicePaymentsInput> | UpdateInvoicePaymentsInput
  >;
  status?: InputMaybe<InvoiceStatus>;
  totalAmount?: InputMaybe<Scalars["Float"]["input"]>;
  vendorId?: InputMaybe<Scalars["Float"]["input"]>;
...
export type UpdateInvoiceMutation = {
  __typename?: "Mutation";
  updateInvoice?: { __typename?: "InvoicesItem"; id: number } | null;
};
...
export type GetOrderOriginsQuery = {
  __typename?: "Query";
  orderOrigins: Array<{
    __typename?: "OrderOriginsItem";
    id: number;
...
export type AddHelloAssoConfigMutation = {
  __typename?: "Mutation";
  addHelloAssoConfig?: {
    __typename?: "HelloAssoConfigItem";
    id: number;
...
export type AddOrUpdateOrderOriginMutationVariables = Exact<{
  id?: InputMaybe<Scalars["Float"]["input"]>;
  name: Scalars["String"]["input"];
  budgetLineIds?: InputMaybe<
    Array<Scalars["Float"]["input"]> | Scalars["Float"]["input"]
  >;
}>;

export type AddOrUpdateOrderOriginMutation = {
  __typename?: "Mutation";
...
export type CloseEditionMutation = {
  __typename?: "Mutation";
  closeEdition?: {
    __typename?: "EditionsItem";
    id: number;
...
export type DeleteOrderOriginMutation = {
  __typename?: "Mutation";
  deleteOrderOrigin?: {
    __typename?: "OrderOriginsItem";
    id: number;
...
export type DisconnectGoogleDriveMutation = {
  __typename?: "Mutation";
...
export type GetEditionClosingSummaryQuery = {
  __typename?: "Query";
  edition?: {
    __typename?: "EditionsItem";
    id: number;
...
export type GetGoogleDriveConfigQuery = {
  __typename?: "Query";
  googleDriveConfig: {
    __typename?: "GoogleDriveConfig";
    editionId: number;
...
export type GetHelloAssoConfigQuery = {
  __typename?: "Query";
  helloAssoConfig?: {
    __typename?: "HelloAssoConfigItem";
    id: number;
...
export type SynchroSalesMutation = {
  __typename?: "Mutation";
  synchroSales: Array<{ __typename?: "SalesItem"; id: number }>;
};
...
export type UpdateGoogleDriveConfigMutation = {
  __typename?: "Mutation";
...
export const AddBudgetLineDocument = {
  kind: "Document",
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "budgetCategoryId" },
          },
          type: {
            kind: "NonNullType",
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "estimatedQuantity" },
          },
          type: {
            kind: "NonNullType",
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "estimatedUnitPrice" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "isFreePrice" },
          },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "LineTypeEnum" },
            },
          },
        },
      ],
...
>;
export const DeleteBudgetLineDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteBudgetLine" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
export const GetBudgetCategoriesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getBudgetCategories" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "budgetCategories" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
  ...
  GetBudgetCategoriesQueryVariables
>;
export const GetBudgetLinesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getBudgetLines" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "budgetLineType" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "excludeHelloAsso" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "budgetLines" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "editionId" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "isFreePrice" } },
                { kind: "Field", name: { kind: "Name", value: "realCost" } },
                { kind: "Field", name: { kind: "Name", value: "salesCount" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "helloAssoProductId" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetBudgetLinesQuery, GetBudgetLinesQueryVariables>;
export const UpdateBudgetLineDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateBudgetLine" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const UpsertBudgetCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "upsertBudgetCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  UpsertBudgetCategoryMutation,
  UpsertBudgetCategoryMutationVariables
>;
export const GetOrderOriginDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getOrderOrigin" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "orderOrigin" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "name" } },
                { kind: "Field", name: { kind: "Name", value: "isPhysical" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "budgetLines" },
                  arguments: [
...
} as unknown as DocumentNode<GetOrderOriginQuery, GetOrderOriginQueryVariables>;
export const GetSumUpConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getSumUpConfig" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "sumUpConfig" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "affiliateKey" },
                },
...
} as unknown as DocumentNode<GetSumUpConfigQuery, GetSumUpConfigQueryVariables>;
export const ValidateOrderDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "validateOrder" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ValidateOrderPaymentMethodInput" },
            },
          },
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "ValidateOrderSalesInput" },
                },
              },
            },
          },
...
>;
export const GetBudgetStatsByCategoriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getBudgetStatsByCategories" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalEstimated" },
                },
  ...
  GetBudgetStatsByCategoriesQuery,
  GetBudgetStatsByCategoriesQueryVariables
>;
export const GetEditionStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEditionStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalPrevisionnalIncome" },
                },
              ],
            },
          },
  ...
  GetEditionStatsQuery,
  GetEditionStatsQueryVariables
>;
export const GetEditionsComparisonDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEditionsComparison" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetEditionsComparisonQuery,
  GetEditionsComparisonQueryVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "openingBalance" },
                },
              ],
            },
          },
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "addInvoice" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "AddInvoicePaymentsInput" },
                },
              },
            },
          },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "withoutTVA" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
      ],
...
} as unknown as DocumentNode<AddInvoiceMutation, AddInvoiceMutationVariables>;
export const AddOrUpdateVendorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "addOrUpdateVendor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const DeleteInvoiceFileDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteInvoiceFile" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "deleteFromDrive" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "status" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "budgetLineId" },
                      },
                      {
                        kind: "Field",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "invoiceFiles" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "UpdateInvoicePaymentsInput" },
              },
            },
          },
        },
...
>;
export const GetOrderOriginsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getOrderOrigins" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "onlyPhysical" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "orderOrigins" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "onlyPhysical" },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "originIds" },
          },
          type: {
            kind: "ListType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "payerFirstName" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "payerLastName" },
                },
                { kind: "Field", name: { kind: "Name", value: "payerEmail" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "helloAssoOrderId" },
                },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "budgetLine" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
export const AddHelloAssoConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddHelloAssoConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "formSlug" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "enableSynchro" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "formSlug" } },
              ],
            },
          },
        ],
...
>;
export const AddOrUpdateOrderOriginDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "addOrUpdateOrderOrigin" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "budgetLineIds" },
          },
          type: {
            kind: "ListType",
            type: {
...
>;
export const CloseEditionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "incomeAdjustment" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "nextEditionName" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "nextEditionStartDate" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "nextEditionEndDate" },
          },
          type: {
            kind: "NonNullType",
            type: {
  ...
  CloseEditionMutation,
  CloseEditionMutationVariables
>;
export const DeleteBudgetCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteBudgetCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const DeleteOrderOriginDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteOrderOrigin" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const DisconnectGoogleDriveDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "disconnectGoogleDrive" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "editionId" } },
  ...
  DisconnectGoogleDriveMutation,
  DisconnectGoogleDriveMutationVariables
>;
export const GetEditionClosingSummaryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEditionClosingSummary" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  GetEditionClosingSummaryQuery,
  GetEditionClosingSummaryQueryVariables
>;
export const GetGoogleDriveConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
>;
export const GetHelloAssoConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getHelloAssoConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "helloAssoConfig" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "editionId" },
...
>;
export const SynchroSalesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "synchroSales" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "helloAssoConfigId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
...
>;
export const UpdateEditionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateEdition" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const UpdateGoogleDriveConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateGoogleDriveConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  UpdateGoogleDriveConfigMutation,
