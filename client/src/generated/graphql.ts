...
export type GetInvoicesQuery = { __typename?: 'Query', invoices: Array<{ __typename?: 'InvoicesItem', id: number, name: string, vendorId: number, totalAmount: string, note?: string | null, executedAt?: string | null, status: InvoicesStatusEnum, vendor?: { __typename?: 'VendorsItem', id: number, name: string } | null, author?: { __typename?: 'UsersItem', id: number } | null, payments: Array<{ __typename?: 'PaymentsItem', id: number, budgetLineId: number, quantity: number, unitPrice: string }> }> };
