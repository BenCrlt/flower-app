...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span className={cn(
        "pointer-events-none flex size-4 shrink-0 items-center justify-center rounded-[4px] border border-input shadow-xs transition-shadow dark:bg-input/30",
        checked
          ? "bg-primary border-primary dark:bg-primary dark:opacity-100"
          : ""
      )}>
